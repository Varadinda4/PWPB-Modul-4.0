                            ...
                            <div class="col-lg-6">
                                <div class="au-card au-card--no-shadow au-card--no-pad m-b-40">
                                    <div class="au-card-title" style="background-image:url('images/bg-title-01.jpg');">
                                        ...
                                        <h3>
                                            <i class="zmdi zmdi-account-calendar"></i>28 Oktober 1997</h3>
                                                    ...
                                                    <div class="au-message__item-inner">
                                                        <div class="au-message__item-text">
                                                            <div class="avatar-wrap">
                                                                <div class="avatar">
                                                                    <img src="<?php echo base_url('assets/Cooladmin-master/images/icon/avatar-02.jpg')?>"alt="John Smith")>
                                                                </div>
                                                            </div>
                                                            <div class="text">
                                                                <h5 class="name">Winwin</h5>
                                                    ...
                                                    <div class="au-message__item-inner">
                                                        <div class="au-message__item-text">
                                                            <div class="avatar-wrap online">
                                                                <div class="avatar">
                                                                    <img src="<?php echo base_url('assets/Cooladmin-master/images/icon/avatar-03.jpg')?>" alt="Nicholas Martinez">
                                                                </div>
                                                            </div>
                                                            <div class="text">
                                                                <h5 class="name">Haruto</h5>
                                                ...
                                                <div class="au-message__item">
                                                    <div class="au-message__item-inner">
                                                        <div class="au-message__item-text">
                                                            <div class="avatar-wrap online">
                                                                <div class="avatar">
                                                                    <img src="<?php echo base_url('assets/Cooladmin-master/images/icon/avatar-04.jpg')?>"alt="Michelle Sims">
                                                                </div>
                                                            </div>
                                                            <div class="text">
                                                                <h5 class="name">Junned</h5>
                                                ...
                                                <div class="au-message__item">
                                                    <div class="au-message__item-inner">
                                                        <div class="au-message__item-text">
                                                            <div class="avatar-wrap">
                                                                <div class="avatar">
                                                                    <img src="<?php echo base_url('assets/Cooladmin-master/images/icon/avatar-05.jpg')?>" alt="Michelle       Sims">
                                                                </div>
                                                            </div>
                                                            <div class="text">
                                                                <h5 class="name">Situ Weilian</h5>
